package com.br.estudo.marcelo.bancodadosutil

import android.content.Context
import android.database.sqlite.SQLiteDatabase
import com.br.estudo.marcelo.bancodadosutil.constantes.CONTATOS_TABLE_DATABASE
import com.br.estudo.marcelo.bancodadosutil.constantes.CONTATOS_TABLE_NAME
...
class BancoDadosHelper(context: Context) :
    ...
    private val scriptSQLCreate = arrayOf(
            ...
            "INSERT INTO $CONTATOS_TABLE_NAME VALUES(5,'mmito@gmail.com','Bolsonaro','R. Teste, 48 - DF, Brasilia, 04125-140, Brasil',800025774,NULL,'www.uol.com.br',NULL);")
